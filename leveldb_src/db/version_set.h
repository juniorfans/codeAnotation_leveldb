...
class VersionSet {
 ...
 private:
  ...
  //lzh: 辅助log文件的FileNumber，在compact memtable时，置为0.
  ...
  // lzh: 各个 level 上进行下一次 compation 的位置(以 InternalKey 来表示)
...
class Compaction {
 ...
 private:
  ...
  // lzh: 设第 i 层的文件的列表是 files , 则它们之中参与到 compaction 的文件起始位置是: level_ptrs_[i],
  // lzh: 即 files[level_ptrs[i]] 是首个参与到 compation 的第 i 层文件 
